...
def add_test_reports(runner, report_name=None):
    ...
    report_path = os.path.join(os.getcwd(), "reports{}{}.study_html".format(separator, int(runner.summary['time']['start_at'])))
    runner.gen_html_report(html_report_template=os.path.join(os.getcwd(), "templates{}extent_report_template.study_html".format(separator)))
