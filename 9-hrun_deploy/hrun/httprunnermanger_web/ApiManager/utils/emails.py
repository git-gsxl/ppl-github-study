...
def send_email_reports(receiver, html_report_path):
    ...
    att["Content-Disposition"] = "attachment;filename = TestReports.study_html"

    body = MIMEText("附件为定时任务生成的接口测试报告，请查收，谢谢！", _subtype='study_html', _charset='gb2312')
...
if __name__ == '__main__':
    send_email_reports('##@qq.com, example@163.com', 'D:\\HttpRunnerManager\\reports\\2018-06-05 15-58-00.study_html')
