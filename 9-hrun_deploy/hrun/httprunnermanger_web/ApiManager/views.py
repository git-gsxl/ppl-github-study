...
def login(request):
    ...
    if request.method == 'POST':
        ...
        if UserInfo.objects.filter(username__exact=username).filter(password__exact=password).count() == 1:
            ...
            return render_to_response("login.study_html")
...
def register(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response("register.study_html")
...
def index(request):
    ...
    return render_to_response('index.study_html', manage_info)
...
def add_project(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('add_project.study_html', manage_info)
...
def add_module(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('add_module.study_html', manage_info)
...
def add_case(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('add_case.study_html', manage_info)
...
def add_config(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('add_config.study_html', manage_info)
...
def run_test(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('report_template.study_html', runner.summary)
...
def project_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render_to_response('project_list.study_html', manage_info)
...
def module_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render_to_response('module_list.study_html', manage_info)
...
def test_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render_to_response('test_list.study_html', manage_info)
...
def config_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render_to_response('config_list.study_html', manage_info)
...
def edit_case(request, id=None):
    ...
    return render_to_response('edit_case.study_html', manage_info)
...
def edit_config(request, id=None):
    ...
    return render_to_response('edit_config.study_html', manage_info)
...
def env_set(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('env_list.study_html', {'account': account})
...
def env_list(request, id):
    ...
    if request.method == 'GET':
        ...
        return render_to_response('env_list.study_html', manage_info)
...
def report_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render_to_response('report_list.study_html', manage_info)
...
def view_report(request, id):
    ...
    return render_to_response('view_report.study_html', {"reports": mark_safe(reports)})
...
def periodictask(request, id):
    ...
    return render_to_response('periodictask_list.study_html', manage_info)
...
def add_task(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('add_task.study_html', info)
...
def download_report(request, id):
    if request.method == 'GET':
        ...
        report_path = os.path.join(os.getcwd(), "reports{}{}.study_html".format(separator, start_at.replace(":", "-")))
        ...
        response['Content-Disposition'] = 'attachment;filename="{0}"'.format(start_at.replace(":", "-") + '.study_html')
        return response
...
def debugtalk(request, id=None):
    if request.method == 'GET':
        ...
        return render_to_response('debugtalk.study_html', debugtalk)
    else:
        id = request.POST.get('id')
...
def debugtalk_list(request, id):
    ...
    return render_to_response('debugtalk_list.study_html', manage_info)
...
def suite_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render_to_response('suite_list.study_html', manage_info)
...
def add_suite(request):
    ...
    if request.is_ajax():
        ...
        return render_to_response('add_suite.study_html', manage_info)
...
def edit_suite(request, id=None):
    ...
    return render_to_response('edit_suite.study_html', manage_info)
...
def echo(request):
    if not request.is_websocket():
        return render_to_response('echo.study_html')
    else:
        servers = []
